...
8. 更新$$W_{io}$$和$$W_{ho}$$
$$\left\{\begin{matrix}
 \frac{\partial o_t}{\partial W_{io}}&=\frac{\partial o_t}{\partial \sigma}\frac{\partial \sigma}{\partial W_{io}}
=\sigma (1-\sigma )\odot x^\top_t & \text{(8)}\\
\frac{\partial o_t}{\partial W_{ho}}&=\frac{\partial o_t}{\partial \sigma}\frac{\partial \sigma}{\partial W_{ho}}
=\sigma (1-\sigma )\odot h^\top_{t-1} & \text{(9)}
\end{matrix}\right.$$

9. 更新$$W_{ig}$$和$$W_{hg}$$
$$\left\{\begin{matrix}
 \frac{\partial g_t}{\partial W_{ig}}&=\frac{\partial g_t}{\partial \tanh}\frac{\partial \tanh}{\partial W_{ig}}
=(1-\tanh^2 )\odot x^\top_t & \text{(10)}\\
\frac{\partial g_t}{\partial W_{hg}}&=\frac{\partial g_t}{\partial \tanh}\frac{\partial \tanh}{\partial W_{hg}}
=(1-\tanh^2)\odot h^\top_{t-1} & \text{(11)}
\end{matrix}\right.$$

10. 更新$$W_{if}$$和$$W_{hf}$$
$$\left\{\begin{matrix}
 \frac{\partial f_t}{\partial W_{if}}&=\frac{\partial f_t}{\partial \sigma}\frac{\partial \sigma}{\partial W_{if}}
=\sigma (1-\sigma )\odot x^\top_t & \text{(12)}\\
\frac{\partial f_t}{\partial W_{hf}}&=\frac{\partial f_t}{\partial \sigma}\frac{\partial \sigma}{\partial W_{hf}}
=\sigma (1-\sigma )\odot h^\top_{t-1} & \text{(13)}
\end{matrix}\right.$$

11. 更新$$W_{ii}$$和$$W_{hi}$$
$$\left\{\begin{matrix}
 \frac{\partial i_t}{\partial W_{ii}}&=\frac{\partial i_t}{\partial \sigma}\frac{\partial \sigma}{\partial W_{ii}}
=\sigma (1-\sigma )\odot x^\top_t & \text{(14)}\\
\frac{\partial i_t}{\partial W_{hi}}&=\frac{\partial i_t}{\partial \sigma}\frac{\partial \sigma}{\partial W_{hi}}
=\sigma (1-\sigma )\odot h^\top_{t-1} & \text{(15)}
\end{matrix}\right.$$
