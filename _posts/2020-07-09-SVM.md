...
$$\left\{ \begin{array}{l}
\frac{{\partial f}}{{\partial {x_i}}} + \sum\limits_{j = 1}^m {{\mu _j}} \frac{{\partial {g_j}}}{{\partial {x_i}}} + \sum\limits_{k = 1}^l {{\lambda _k}\frac{{\partial {h_k}}}{{\partial {x_i}}}}  = 0,{\rm{ }}\left( {i = 1,2,...,n} \right)\\
{h_k}\left( {\bf{x}} \right) = 0,{\rm{ (}}k = 1,2, \cdots ,l)\\
{\mu _j}{g_j}\left( {\bf{x}} \right) = 0,{\rm{ (}}j = 1,2, \cdots ,m)\\
{\mu _j} \ge 0.
\end{array} \right.$$
