...
You could found that $$\mathbf{\lambda^T Q \lambda} \geq 0$$ shows `L` is convex function , and `Q` is positive semi-definite 
...
![smo](/images/MachineLearing/smo.png)
...
$$E_i = f(x_i) - y_i = \sum_{j = 1}^N\lamda_jy_jK(\vec{x_i},\vec{x_j}) + b) - y_i$$
...
3. [libsvm](http://www.csie.ntu.edu.tw/~cjlin/papers/libsvm.pdf)
...
5. [svm原论文中文翻译](https://zhuanlan.zhihu.com/p/23068673)
