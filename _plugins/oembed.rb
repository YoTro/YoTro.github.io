...
#   - requires https://github.com/YoTro/ruby-oembed/
#
...
# since register_all does not register all default providers, we need to do this here. See https://github.com/YoTro/ruby-oembed/issues/18
